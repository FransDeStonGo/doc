...
| Файл | Тип | Статус | Теги | Описание |
|------|-----|--------|------|---------|
| `agents/agents.md` | nav | draft | agents, architecture, overview | Навигация по разделу: что есть сейчас + планы |
...
| `ai/anthropic/anthropic.md` | reference | draft | anthropic, claude, models | Обзор Anthropic: модели Claude, сильные стороны для агентов |
| `ai/anthropic/claude/claude.md` | reference | draft | anthropic, claude, tool-use, safety | Claude Sonnet/Opus/Haiku — характеристики, агентные сценарии |
| `ai/openai/openai.md` | reference | draft | openai, gpt, o-series, models | GPT-4o, o3, o4-mini — характеристики, экосистема |
| `ai/google/google.md` | reference | draft | google, gemini, long-context, multimodal | Gemini 2.5 Pro/Flash — рекордный контекст 1M токенов |
| `ai/meta/meta.md` | reference | draft | meta, llama, open-source, self-hosted | Llama 3.x — open weights, локальный деплой |
| `ai/mistral/mistral.md` | reference | draft | mistral, codestral, gdpr, european | Mistral Large, Codestral — GDPR-compliant европейский вариант |
| `ai/deepseek/deepseek.md` | reference | draft | deepseek, reasoning, open-source, cheap | DeepSeek V3/R1 — лучшая цена/качество, reasoning open weights |
| `ai/qwen/qwen.md` | reference | draft | qwen, alibaba, open-source, code | Qwen2.5 — open-source от Alibaba, сильный code и vision |
| `ai/perplexity/perplexity.md` | reference | draft | perplexity, sonar, web-search, citations | Sonar — модели с нативным веб-поиском и citations |
...
| Файл | Тип | Статус | Теги | Описание |
|------|-----|--------|------|---------|
| `mcp/mcp.md` | nav | draft | mcp, protocol, tools, servers | Навигация: протокол, серверы, кастомные серверы, конфигурация |
...
| Файл | Тип | Статус | Теги | Описание |
|------|-----|--------|------|---------|
| `providers/providers.md` | nav | draft | providers, api, openrouter, routing | Навигация: OpenRouter (приоритет), Anthropic, OpenAI, Google, Groq |
...
| Файл | Тип | Статус | Теги | Описание |
|------|-----|--------|------|---------|
| `skills/skills.md` | nav | stub | skills, slash-commands, claude-code, automation | Навигация: анатомия skill, встроенные, кастомные, шаблоны |
